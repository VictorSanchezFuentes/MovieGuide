...
namespace MoviesApi.Helpers
{
    public class AutoMapperProfiles: Profile
    {
        public AutoMapperProfiles(GeometryFactory geometryFactory) {
            ...
            //Pay attention because the AI makes the mistake of first
            //giving you latitude and then longitude.
        ...
        private List<MoviesActors> MapMovieActors(MovieCreationDTO movieCreationDTO,
            Movie movie)
        {
